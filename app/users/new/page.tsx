...
import { ArrowLeft, Save, Shield, Mail } from 'lucide-react'
import {
  Select,
  SelectContent,
  SelectItem,
...
const rolePermissionTemplates: Record<string, typeof defaultPermissions> = {
  'Clinic Owner': {
    dashboard: true,
...
export default function NewUserPage() {
  const [formData, setFormData] = useState({
    ...
    phone: '',
    role: '',
    branches: ['Main Branch'] as string[],
    status: 'active',
  })
      ...
      <form onSubmit={handleInvite} className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-foreground">Invite Team Member</h1>
            <p className="text-muted-foreground mt-1">Send an invitation link to a new team member</p>
          </div>
        ...
        <Card className="border-border">
          <CardHeader>
            ...
            <CardDescription>Assign the user&apos;s role and branch access. Users can be assigned to single or multiple branches.</CardDescription>
          </CardHeader>
          <CardContent>
